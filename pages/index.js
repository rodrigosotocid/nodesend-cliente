        ...
        {url ? (
          <>
            <p className="text-center text-2xl mt-10">
              <span className="font-bold text-red-700 text-3xl uppercase">La URL de tu archivo es: </span>{`${process.env.frontendURL}/enlaces/${url}`}
            </p>
            <button
              type="button"
          ...
          <p>
            ...
            <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
              ...
              te permite compartir archivos con cifrado de extremo a extremo y un archivo que es eliminado después de ser descargado.
